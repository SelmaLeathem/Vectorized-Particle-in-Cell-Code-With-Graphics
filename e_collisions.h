 ...
 * 
 * 
 * This file defines the e_collisions class which stores data and defines
...
class e_collisions:public collisions
{
 ...
 public:
   ...
   */
    ...
    * supply functions.
    */
     double sigma_Ar_elastic(void);  // for Argon 
     double sigma_Ar_ionize(void);
     double sigma_H_elastic(void);  // for Hydrogen
     double sigma_H_ionize(void);


   private:
     double energy; // impact energy
     double threshold;  // threshold energy
     double constant_elastic; // constant elastic cross-section
     double constant_ionization; // constant ionization cross-section

     double *probabilityE; // holds elastic collision probabilities
     double *probabilityI; // holds ionization collision probabilities

     int countQualifying; //TO REMOVE
