 ...
 * 
 * 
 * This file defines the ion_collisions class which stores data and defines
...
class ion_collisions: public collisions
{
 ...
 public:
   ...
   */
   ...
   double sigma_H_cx(void);

   private:

    // energy and center-of-mass energy
    double energy, CMenergy;

    // elastic and charge-exchange cross sections for center-of-mass
    // calculations
    bool center_mass_El,center_mass_CX;
    double constant_elastic;  // constant elastic cross section
    double constant_cx;  // constant charge exchange

     double *probabilityCX; // holds elastic collision probabilities
   /*
